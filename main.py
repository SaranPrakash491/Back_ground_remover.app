...
st.write(
    ":dog: Try uploading an image to watch the background magically removed. Full quality images can be downloaded from the sidebar. This code is open source and available  on GitHub. Special thanks to the https://github.com/SaranPrakash491 :grin:"
)
...
if my_upload is not None:
    ...
    default_images = ["936938_original_1887x4096.jpg"]
